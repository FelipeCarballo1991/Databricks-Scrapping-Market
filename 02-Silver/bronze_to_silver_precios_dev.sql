-- ========================================
-- PIPELINE BRONZE → SILVER: PRECIOS PRODUCTOS [DEV]
-- ========================================
--
-- Autor: Data Engineering Team
-- Fecha: 2026-04-10
-- Entorno: DESARROLLO (supermercadoetl_dev)
...
CREATE SCHEMA IF NOT EXISTS supermercadoetl_dev.silver
COMMENT 'Capa Silver - Datos curados y validados [DEV]';

-- Paso 2: Crear tabla Silver con esquema completo
CREATE TABLE IF NOT EXISTS supermercadoetl_dev.silver.precios_productos (
  producto_id STRING 
...
USING DELTA
COMMENT 'Tabla Silver con precios de productos de supermercados - histórico diario [DEV]'
TBLPROPERTIES (
...
MERGE INTO supermercadoetl_dev.silver.precios_productos AS target
USING (
  SELECT
